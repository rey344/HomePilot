...
## Example Resume-Style Description

You can describe this project on a resume or portfolio as:

> **HomePilot – AI-Assisted Homebuying & Financial Planning Platform (2026)**  
> Next.js, TypeScript, FastAPI, PostgreSQL, REST APIs, Docker, AI Integration  
> • Built a full-stack financial decision platform that calculates true homeownership cost (PITI + HOA + PMI + maintenance) and benchmarks affordability using the 50/30/20 budgeting framework.  
> • Designed a modular FastAPI backend with clear domain separation (calculation engine, profile modeling, AI services) and type-safe API schemas exposed via OpenAPI.  
> • Implemented a mortgage amortization engine with configurable loan terms, credit-score-based PMI estimation, and extensible modeling hooks for extra payments and rate changes.  
> • Architected the system as a production-ready monorepo with Dockerized services (frontend, backend, Postgres) and clean, self-documenting REST APIs.
